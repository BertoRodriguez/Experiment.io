...
# You need a .env file in your project which stores your secrets
...
CSRF_TRUSTED_ORIGINS = ['https://*.eu.ngrok.io/','https://*.127.0.0.1',"https://*.ngrok-free.app/"]

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

# Change as needed for hosting provider
ALLOWED_HOSTS = ["*"]
